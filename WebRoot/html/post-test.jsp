<%@ page language="java" import="java.util.*,com.findu.entity.*,com.findu.dao.*" pageEncoding="utf-8"%>
...
<body>
    ...
    <div class="submit-ad main-grid-border">
        <div class="container">
        <h2 class="w3-head">拾物发布</h2>
        	<div class="post-ad-form">
        	<!-- enctype="multipart/form-data" -->
                <form id="information" action="/FindU/servlet/TestServlet" method="post" enctype="multipart/form-data">
                 	<label class="post-terms"><font color='#ff0000'><%=msg %></font></label>
					...
					%>	
                        <option value="<%=type2.getAllTypes().get(i).getTypename() %>"><%=type2.getAllTypes().get(i).getTypename() %></option>
					<%
					}
					%>
                    </select>	
                    ...
                    <input type="text" class="phone" name="GoodName" placeholder="" required="">
                    <div class="clearfix"></div>
                    <label>详情说明 <span>*</span></label>
                    <textarea class="mess" name="Explain" placeholder="请尽量描述你所拾到物品的详细信息，帮助失主更好的找到它" required=""></textarea>
                    <div class="clearfix"></div>       
                    ...
                    <div class="personal-details">
                            ...
                            <input type="text" class="phone" name="GetSite" placeholder="" required="">
                            <div class="clearfix"></div>
                            <label>联系方式 <span>*</span></label>
                            <input type="text" class="email" name="Contact" placeholder="" required="">
                            <div class="clearfix"></div>
							<label>估计价值 <span>*</span></label>
							<input type="text" class="email" name="Value" placeholder="输入范围：0~9999" required="">		
                            <div class="clearfix"></div>
		                    ...
		                    <div class="photos-upload-view">
		                        ...
		                        <div id="messages">
		                            <p>图片预览窗口 【注：单个文件上传不得超过5MB 限 jpg/png/gif 格式】</p>
