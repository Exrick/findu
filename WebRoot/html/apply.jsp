...
<body>
    ...
    <div class="submit-ad main-grid-border">
        <div class="container">
            <h2 class="w3-head">物品申领<span class="postmsg"><%=msg %></span></h2>
            <div class="post-ad-form">
                <form action="/FindU/servlet/ApplyServlet" method="post" enctype="multipart/form-data">
                 	<div class="clearfix"></div>
                 	<% 
		          		String str="";
		            	GoodsDAO goods = new GoodsDAO();
		            	if("".equals(request.getParameter("id"))||request.getParameter("id")==null){
		            		response.setHeader("Refresh","0;URL=/FindU/html/apply-error.jsp");
    						return ;
		            	}

		            	Good g = goods.getGoodById(Integer.parseInt(request.getParameter("id")));
		            	if(g!=null)
		            	{
		            		str=request.getParameter("id");
            		%>	
            		<input type="text" name="ID" value="<%=str %>" hidden>
                    ...
                    <textarea class="mess" name="Explain" placeholder="请尽量描述你丢失该物品的详细信息，让拾到者确信是属于你的失物" required=""></textarea>
                    <div class="clearfix"></div>       
                    ...
                    <div class="personal-details">
	                        ...
	                        <div class="photos-upload-view">
	                            ...
	                            <div id="messages">
	                                <p>图片预览窗口 【注：单个文件上传不得超过5MB 限 jpg/png/gif/jpeg 格式】</p>
